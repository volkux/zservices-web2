 ...
 */
const O = window, B = O.ShadowRoot && (O.ShadyCSS === void 0 || O.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, it = Symbol(), W = /* @__PURE__ */ new WeakMap();
class ht {
  constructor(t, e, i) {
...
const at = (n) => new ht(typeof n == "string" ? n : n + "", void 0, it), dt = (n, t) => {
 ...
 */
var M;
const R = window, K = R.trustedTypes, ct = K ? K.emptyScript : "", Z = R.reactiveElementPolyfillSupport, I = { toAttribute(n, t) {
  switch (t) {
    case Boolean:
      n = n ? ct : null;
      break;
  ...
  return e;
} }, st = (n, t) => t !== n && (t == t || n == n), z = { attribute: !0, type: String, converter: I, reflect: !1, hasChanged: st };
...
f.finalized = !0, f.elementProperties = /* @__PURE__ */ new Map(), f.elementStyles = [], f.shadowRootOptions = { mode: "open" }, Z == null || Z({ ReactiveElement: f }), ((M = R.reactiveElementVersions) !== null && M !== void 0 ? M : R.reactiveElementVersions = []).push("1.4.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var j;
const N = window, m = N.trustedTypes, J = m ? m.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, v = `lit$${(Math.random() + "").slice(9)}$`, nt = "?" + v, ut = `<${nt}>`, y = document, C = (n = "") => y.createComment(n), w = (n) => n === null || typeof n != "object" && typeof n != "function", ot = Array.isArray, pt = (n) => ot(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", S = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, F = /-->/g, G = />/g, _ = RegExp(`>|[ 	
\f\r](?:([^\\s"'>=/]+)([ 	
\f\r]*=[ 	
\f\r]*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Q = /'/g, X = /"/g, rt = /^(?:script|style|textarea|title)$/i, g = Symbol.for("lit-noChange"), u = Symbol.for("lit-nothing"), Y = /* @__PURE__ */ new WeakMap(), A = y.createTreeWalker(y, 129, null, !1), $t = (n, t) => {
  ...
  for (let l = 0; l < e; l++) {
    ...
    for (; p < h.length && (r.lastIndex = p, a = r.exec(h), a !== null); )
      p = r.lastIndex, r === S ? a[1] === "!--" ? r = F : a[1] !== void 0 ? r = G : a[2] !== void 0 ? (rt.test(a[2]) && (s = RegExp("</" + a[2], "g")), r = _) : a[3] !== void 0 && (r = _) : r === _ ? a[0] === ">" ? (r = s != null ? s : S, c = -1) : a[1] === void 0 ? c = -2 : (c = r.lastIndex - a[2].length, $ = a[1], r = a[3] === void 0 ? _ : a[3] === '"' ? X : Q) : r === X || r === Q ? r = _ : r === F || r === G ? r = S : (r = _, s = void 0);
    const U = r === _ && n[l + 1].startsWith("/>") ? " " : "";
    o += r === S ? h + ut : c >= 0 ? (i.push($), h.slice(0, c) + "$lit$" + h.slice(c) + v + U) : h + v + (c === -2 ? (i.push(void 0), l) : U);
  }
          ...
          for (const c of s.getAttributeNames())
            if (c.endsWith("$lit$") || c.startsWith(v)) {
              ...
              if (a.push(c), p !== void 0) {
                ...
                l.push({ type: 1, index: o, name: H[2], strings: U, ctor: H[1] === "." ? _t : H[1] === "?" ? At : H[1] === "@" ? mt : k });
              } else
...
class vt {
  ...
  v(t) {
    ...
    for (; h !== void 0; ) {
      if (d === h.index) {
        let $;
        h.type === 2 ? $ = new x(r, r.nextSibling, this, t) : h.type === 1 ? $ = new h.ctor(r, h.name, h.strings, this, t) : h.type === 6 && ($ = new yt(r, this, t)), this.u.push($), h = s[++l];
      }
...
class x {
  ...
  _$AI(t, e = this) {
    t = E(this, t, e), w(t) ? t === u || t == null || t === "" ? (this._$AH !== u && this._$AR(), this._$AH = u) : t !== this._$AH && t !== g && this.g(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : pt(t) ? this.k(t) : this.g(t);
  }
  O(t, e = this._$AB) {
  ...
  g(t) {
    this._$AH !== u && w(this._$AH) ? this._$AA.nextSibling.data = t : this.T(y.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    var e;
  ...
  k(t) {
    ...
    let i, s = 0;
    for (const o of t)
      s === e.length ? e.push(i = new x(this.O(C()), this.O(C()), this, this.options)) : i = e[s], i._$AI(o), s++;
  ...
  _$AI(t, e = this, i, s) {
    ...
    if (o === void 0)
      ...
      for (t = o[0], l = 0; l < o.length - 1; l++)
        h = E(this, d[i + l], e, l), h === g && (h = this._$AH[l]), r || (r = !w(h) || h !== this._$AH[l]), h === u ? t = u : t !== u && (t += (h != null ? h : "") + o[l + 1]), this._$AH[l] = h;
    }
    r && !s && this.j(t);
  }
  j(t) {
...
tt == null || tt(P, x), ((j = N.litHtmlVersions) !== null && j !== void 0 ? j : N.litHtmlVersions = []).push("2.4.0");
const gt = (n, t, e) => {
  var i, s;
  ...
  if (r === void 0) {
    ...
    o._$litPart$ = r = new x(t.insertBefore(C(), d), d, void 0, e != null ? e : {});
  }
  return r._$AI(n), r;
};
/**
...
((L = globalThis.litElementVersions) !== null && L !== void 0 ? L : globalThis.litElementVersions = []).push("3.2.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
var bt = Object.defineProperty, Ct = Object.getOwnPropertyDescriptor, V = (n, t, e, i) => {
