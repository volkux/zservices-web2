function c(t, o, a, d, s, i, f, u) {
  var e = typeof t == "function" ? t.options : t;
  o && (e.render = o, e.staticRenderFns = a, e._compiled = !0), d && (e.functional = !0), i && (e._scopeId = "data-v-" + i);
  var r;
  if (f ? (r = function(n) {
  ...
  }, e._ssrRegister = r) : s && (r = u ? function() {
    s.call(
      this,
...
const m = {
  ...
  mounted() {
    var o;
    if (!this.html || !((o = this.$refs) != null && o.wrapper))
      return;
    const t = document.createRange().createContextualFragment(this.html);
    this.$refs.wrapper.append(t);
  }
};
var v = function() {
